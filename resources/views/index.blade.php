        ...
        <div class="container">
            ...
            <div class="col-lg-4 bordering" id="section1">
                ...
                <form action="/payment" method="POST" name="myForm" class="order my-5">
                    ...
                    <div>
                        <input type="text" name="invoices" value="<?php echo md5('INV-'. time()) ?>" hidden>
                        <input type="text" name="status_transaksi" value="PENDING" hidden>

                        <?php $char = '0123456789abcdefghijklmnopqrstuvwxyz'; ?>

                        <input type="text" name="invoice_tiket"  id="invoice_tiket" value="<?php echo "INV-".strtoupper(substr(str_shuffle($char), 0, 10)); ?>" hidden>
                    </div>
                    <div class="my-5">
